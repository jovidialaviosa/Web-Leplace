                                  ...
                                  <>
                                    <td class="px-6 py-4 mx-auto">
                                      <input
                                        ...
                                        class="bg-gray-50 border border-green-500 text-gray-500 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-10 p-2.5"
                                        onChange={(e) => {
                                  ...
                                  <>
                                    <td class="px-6 py-4">
                                      <input
                                        ...
                                        max="100"
                                        placeholder={tugas.nilai}
                                        class="bg-grey-50 border border-grey-500 text-white-500 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-10 p-2.5"
                                        onChange={(e) => {
                                          setNilai(e.target.value);
                                        }}
                                        disabled
                                    ...
                                    <td class="px-6 py-4">
                                      <button
                                        type="submit"
                                        class="text-white bg-green-300 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                                        onClick={() => inputNilai(tugas.id)}
                                        disabled
                                      >
                                        submit
